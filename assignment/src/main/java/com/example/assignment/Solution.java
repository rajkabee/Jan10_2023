...
class Graph {
	 ...
	 * @throws IllegalArgumentException if no vertex with the given ID is in the
	 *                                  graph.
	 */
...
// ------- PUBLIC METHODS -----------------------------------------------------
	...
	/**
	 * Replaces the key of a given vertex and reorders it in the PriorityQueue. If
	 * the key was not in the PriorityQueue yet, it is added.
	 *
